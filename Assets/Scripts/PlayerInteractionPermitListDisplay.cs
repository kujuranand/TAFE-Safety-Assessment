...
public class PlayerInteractionPermitListDisplay : MonoBehaviour
{
    private TextMeshProUGUI listText;
    public RectTransform backgroundRect;
    public Vector2 padding = new Vector2(10f, 10f);
    public string listHeading = "Permit List"; // Heading for the Permit list
    ...
    public void AddPermitItem(string item)
    {
